            ...
            <div class="card-body">
                ...
                <form action="" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="telphone" class="form-control" value="<?= $row['telphone'];?>">
                    </div>
                ...
                if(isset($_POST['submit'])) {
                   ...
                   mysqli_query($koneksi,"update siswa set nama='$nama',telphone='$telphone' where id = '$id'") or die(mysqli_error($koneksi));
