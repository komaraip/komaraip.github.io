							...
							<div class="card-body pb-2">
								<div class="d-sm-flex d-block">
									<ul class="card-list d-flex mt-sm-0 mt-3">
                           				...
                           				<div class="container-kom">
											<div class="details">
												<p>Fullname 	: <?php echo $fetch['fullname']; ?></p>
												<p>Phone 		: <?php echo $fetch['phone']; ?></p>
												<p>Country 		: <?php echo $fetch['country']; ?></p>
												<p>City 		: <?php echo $fetch['city']; ?></p>
												<p>Address 		: <?php echo $fetch['address']; ?></p>
												<p>Postal Code 	: <?php echo $fetch['postalcode']; ?></p>
											</div>
									...
									<ul class="card-list d-flex mt-sm-0 mt-3">
                           				<div class="container-kom">
											<div class="details-kom">
												<p>Card / Bank	: <?php echo $fetch['card']; ?></p>
												<p>Card	Number	: <?php echo $fetch['cardnumber']; ?></p>
												<p>Card Balance : <?php echo $fetch['balance']; ?></p>
												<p>Currency 	: <?php echo $fetch['currency']; ?></p>
											</div>
