<?php
  ...
  session_start(); // Mulai session, pastikan ini dijalankan setelah proses login
  ...
  if(isset($_POST["submit"])){
    ...
    // Mendapatkan userID dari session atau variabel global setelah login
    // Misalnya, jika Anda menyimpan userID dalam session dengan nama 'user_id'
    if(isset($_SESSION['id'])) {
      $userID = $_SESSION['id'];

      $query = "INSERT INTO `trans` (`transaction`, `date`, `time`, `balance`, `category`, `userID`)
                VALUES ('$transaction', '$date', '$time', '$balance', '$category', '$userID')";
