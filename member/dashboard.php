						...
						<div class="card box-shadow-none">
							<div class="card-body">
								...
								<div class="d-flex align-items-center">
									<div class="me-auto">
										<p class="fs-16 mb-0 mt-2"> Set for <span class="text-danger">4,500,000</span></p>
										...
										<br>
										<input class="form-control" type="text" placeholder="Change your limit">
									</div>
					...
					<div class="col-xl-6 col-xxl-5">
						<div class="card box-shadow-none">
							...
							<div class="card-footer border-0 pt-0">
								<a href="transaction.php" class="btn btn-outline-primary d-block btn-lg">View More</a>
							</div>
						</div>
					</div>				
